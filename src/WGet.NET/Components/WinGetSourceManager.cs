...
namespace WGetNET
{
    ...
    public class WinGetSourceManager : WinGet
    {
        ...
        /// </param>
        public WinGetSourceManager(string host, string username, string password) : base(host, username, password)
        {
        ...
        /// A <see cref="System.String"/> containing the ssh user password.
        /// </param>
        public WinGetSourceManager(string host, int port, string username, string password) : base(host, port, username, password)
        {
            // Provide constructor for ssh client.
        }
