...
#pragma warning disable
    internal class Program
    {
        ...
        private void Run()
        {
            ...
            try
            {
                Console.WriteLine("TEST APP NET 6 (SSH)\n\n");

                // Data for local test VM
                string sshHost = "192.168.188.31";
                string sshUser = "test";
                string sshPw = "123Test123";

                Console.WriteLine("=== Winget Information ===");
                WinGetPackageManager connector = new WinGetPackageManager(sshHost, sshUser, sshPw);
                WinGetSourceManager sourceManager = new WinGetSourceManager(sshHost, sshUser, sshPw);
                WinGet winget = new WinGet(sshHost, sshUser, sshPw);
